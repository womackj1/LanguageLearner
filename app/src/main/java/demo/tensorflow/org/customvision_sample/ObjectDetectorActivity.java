        ...
        runInBackground(
                new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (frameCount % 12 == 0 || frameCount % 12 == 1 || frameCount % 12 == 2 || frameCount % 12 == 3 || frameCount % 12 == 4) {
                            if (results != null && results.size() > 0) {
                                ObjectDetector.BoundingBox obj = results.get(0); // remember first item
                                results.clear(); // clear complete list
                                results.add(obj); // add first item

                                text = obj.getClassIdentifier();
                                ...
                                t1.speak(text, TextToSpeech.QUEUE_FLUSH, null,"tts1");
                            }
